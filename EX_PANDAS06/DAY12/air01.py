...
# 파일 불러오기
dust=pd.read_excel(r'C:\Users\kdp\Desktop\KDT\EX_PANDAS06\data\dust.xlsx')
...
dust=dust[['date','year','month','day','so2','co','o3','no2','PM10',
           'PM2.5']]
print(dust.columns)
...
# ------------------------------------------------------
weather=pd.read_excel(r'C:\Users\kdp\Desktop\KDT\EX_PANDAS06\data\weather.xlsx')
